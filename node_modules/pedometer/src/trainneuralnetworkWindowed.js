 ...
 **/
var timeWindow=1024; //Must be power of 2
var timeStep=32; //Stepsize in samples of window to be slided along signal
...
if (recreateSet){
    ...
    walkingdata[7]=fs.readFileSync('./data/DataSupermarkt1.csv','utf8');
    walkingdata[8]=fs.readFileSync('./data/DataSupermarkt2.csv','utf8');
    walkingdata[9]=fs.readFileSync('./data/DataSupermarkt3.csv','utf8');
    walkingdata[10]=fs.readFileSync('./data/DataSupermarkt4.csv','utf8');
    walkingdata[11]=fs.readFileSync('./data/DataVater1.csv','utf8');
    walkingdata[12]=fs.readFileSync('./data/DataVater2.csv','utf8');
    walkingdata[13]=fs.readFileSync('./data/DataBahnhof1.csv','utf8');
    walkingdata[14]=fs.readFileSync('./data/DataBahnhof2.csv','utf8');
    ...
    set=JSON.parse(fs.readFileSync('./data/maximalWindowedInputData.json','utf8'));
}
...
var myPerceptron = new Architect.Perceptron(inputs, 10,10, 1);
...
fs.writeFileSync('./data/neuralnetworkWindowed6.json',JSON.stringify(myPerceptron.toJSON()),'utf8');
