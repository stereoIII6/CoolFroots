...
export declare type WalletType = 'web3' | 'walletconnect';
...
export interface UserInfo extends Partial<WalletClaims>, Partial<EmailClaims>, Partial<AddressClaims>, Partial<PhoneClaims>, Partial<ProfileClaims> {
    sub: string;
}
